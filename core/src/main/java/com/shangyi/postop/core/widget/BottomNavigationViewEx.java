package com.shangyi.postop.core.widget;
...
//        System.out.println("mMenuView:" + mMenuView + " mButtons:" + mButtons + " mOnClickListener" + mOnClickListener);
    ...
    public BottomNavigationView.OnNavigationItemSelectedListener getOnNavigationItemSelectedListener() {
        ...
        BottomNavigationView.OnNavigationItemSelectedListener mListener = getField(getClass().getSuperclass(), this, "mSelectedListener", BottomNavigationView.OnNavigationItemSelectedListener.class);
        return mListener;
    }
...
//            Log.d("onPageSelected", "--------- position " + position + " ------------");
    ...
    private static class MyOnNavigationItemSelectedListener implements BottomNavigationView.OnNavigationItemSelectedListener {
        ...
        MyOnNavigationItemSelectedListener(ViewPager viewPager, BottomNavigationViewEx bnve, boolean smoothScroll, BottomNavigationView.OnNavigationItemSelectedListener listener) {
