...
import com.fly.postop.core.utils.CommitUtils;
import com.fly.postop.core.utils.DrawableUtils;
...
public class Toolbar extends android.support.v7.widget.Toolbar {
    ...
    public void setTextDrawableLeft(@DrawableRes int resId) {
        if (mTitleText != null && resId > 0) {
            mTitleText.setCompoundDrawablePadding(CommitUtils.dip2px(10));
    ...
    private void init() {
        ...
        LayoutParams lp = new LayoutParams(CommitUtils.dip2px(getContext(), ViewGroup.LayoutParams.WRAP_CONTENT),
