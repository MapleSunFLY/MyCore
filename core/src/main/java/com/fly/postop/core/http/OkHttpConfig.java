...
import com.fly.postop.core.http.cookie.CookieJarImpl;
import com.fly.postop.core.http.cookie.store.CookieStore;
import com.fly.postop.core.http.interceptor.HeaderInterceptor;
import com.fly.postop.core.http.interceptor.NetCacheInterceptor;
import com.fly.postop.core.http.interceptor.NoNetCacheInterceptor;
import com.fly.postop.core.http.interceptor.RxHttpLogger;
...
public class OkHttpConfig {
    ...
    public static class Builder {
        ...
        private void setCacheConfig() {
            defaultCachePath = BaseApplication.getAppContext().getExternalCacheDir().getPath() + "/RxHttpCacheData";
            if (isCache) {
                Cache cache;
