package com.shangyi.postop.http.sign;
...
import com.shangyi.postop.utils.NetUtils;
...
public class DeviceInfoConfig {
    ...
    public String imsi;//运营商（中国电信，中国移动，等）0 1 2
    ...
    public static DeviceInfoConfig getInstance() {
        if (mDeviceInfoConfig == null) {
            ...
            mDeviceInfoConfig.init(HttpUtils.getContext());
        }
        return mDeviceInfoConfig;
    }

    public void init(Context context) {
        this.appType = context.getResources().getInteger(R.integer.app_type);
